...
description: "Detects, tests, and hardens against prompt injection attacks in LLM applications — system prompt extraction, jailbreaks, indirect injection via user content. Trigger: 'prompt injection', 'jailbreak', 'AI security', 'harden my prompt', 'adversarial inputs', 'can users manipulate my AI?'"
---
