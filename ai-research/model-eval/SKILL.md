---
name: model-eval
description: "Designs custom evaluation frameworks for LLM-powered features — test set design, scoring criteria, automated eval pipelines, and human eval protocols. Trigger: 'evaluate my model', 'build eval', 'measure quality', 'eval framework', 'how do I know if my prompt is working?'"
---
