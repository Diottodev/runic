---
name: git-commit
description: "Generates Conventional Commit messages from a diff or change description — subject, body, breaking change footer, and multiple options to choose from. Trigger: 'commit message', 'write a commit', 'help me commit', 'generate commits'"
---
