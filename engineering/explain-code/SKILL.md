---
name: explain-code
description: "Explains what code does with adjustable depth — beginner (analogies), intermediate (design decisions), or expert (nuances and trade-offs). Trigger: 'what does this do?', 'explain this code', 'how does this work?', 'walk me through'"
---
