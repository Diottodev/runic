---
name: refactor
description: "Refactors code following Clean Code, SOLID, DRY, or performance principles — always explains what changed and why, never silently changes behavior. Trigger: 'refactor', 'clean up', 'improve', 'simplify', 'this feels wrong'"
---
