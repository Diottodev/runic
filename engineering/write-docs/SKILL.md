---
name: write-docs
description: "Generates JSDoc, TSDoc, Python docstrings, or strategic inline comments for code — explains the why, not the what. Trigger: 'document', 'add docs', 'add JSDoc', 'add comments', 'write docstrings'"
---
