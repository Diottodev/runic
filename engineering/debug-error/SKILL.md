---
name: debug-error
description: "Diagnoses errors and stack traces, identifies root cause (not just symptoms), and provides a fix with code example and prevention strategy. Trigger: error message, stack trace, exception, 'not working', 'failing test', 'build crash'"
---
