---
name: generate-tests
description: "Generates complete unit tests with Arrange/Act/Assert structure for any function or module, supporting Jest, Vitest, Pytest, and Go test. Trigger: 'write tests', 'generate tests', 'add test coverage', 'how do I test this?'"
---
