...
description: "Designs, evaluates, and iterates on LLM prompts — system prompts, few-shot examples, chain-of-thought, structured outputs, and prompt testing. Trigger: 'improve prompt', 'write a system prompt', 'prompt design', 'my prompt is not working', 'better results from LLM'"
---
